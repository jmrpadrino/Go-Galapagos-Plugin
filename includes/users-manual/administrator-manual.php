<?php
    //Empieza el html del manual de usuario
    $show_administrator_manual = false;
    if( current_user_can('administrator') ){
        $show_administrator_manual = true;
    }
?>
                    <div role="tabpanel" class="tab-pane" id="adminmanual">
                        <div class="row">
                            <div class="col-xs-12">
                                <h3><i class="fa fa-user-circle-o" aria-hidden="true"></i> Administrator's Manual</h3>
                            </div>
                        </div>
                        <?php if($show_administrator_manual){?>
                        <div class="row">
                            <div id="#admin_manual_navigation" class="col-sm-2">
                                <div id="sticky-table-admin-content" class="sticky-table-content">
                                    <h4 class="table-content-title"><i class="fa fa-list" aria-hidden="true"></i> Table of content</h4>
                            ...
                            <div class="col-sm-10 user-manual-info">
                                <div id="item1" class="spacing-item">
                                    <h5>Item 1</h5>
                                ...
                                <div id="item2" class="spacing-item">
                                    <h5>Item 2</h5>
                                ...
                                <div id="item3" class="spacing-item">
                                    <h5>Item 3</h5>
                                ...
                                <div id="item4" class="spacing-item">
                                    <h5>Item 4</h5>
                            ...
                            <div class="col-sm-6 col-sm-offset-3">
                                <div class="row">
                                    <div class="col-sm-12 text-center">
                                        <img style="margin: 0 auto;" src="<?php echo RUTAPLUGINGOGALAPAGOS; ?>images/admin-user-talking-to.png" class="img-responsive">
                                        <h2>This information is for wordpress administrator users only.</h2>
                                        <p>If you need this information please contact <a href="#support" aria-controls="support" role="tab" data-toggle="tab"><i class="fa fa-ambulance" aria-hidden="true"></i> Support</a>.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
